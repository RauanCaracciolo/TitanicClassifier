...
#Create the model
titanic_dt = DecisionTreeClassifier(random_state=100) #Padronize the random state as 100 for making the randomness have reduces weight when comparing the models
